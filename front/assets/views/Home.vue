<template>
    <div class="home">
        ...
        <div class="home__part2" :style="styleRules">

            <div class="home__introduction">
                <h1> Bienvenue sur Shabadabada </h1>
...
.home__part1 {
    ...
    .button__click-here {
        ...
        border-radius: 10px;
        padding: 5px 15px;
        margin: $spacing-double 0 $spacing-double 0;
        font-family: "Lazer84";
        word-spacing: 0.4rem;
